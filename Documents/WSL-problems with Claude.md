...
>
> **Quick Reference:** For a concise overview of key WSL + Claude Code issues (especially JetBrains integration), see [WSL-CLAUDE-QUICK-REFERENCE.md](./WSL-CLAUDE-QUICK-REFERENCE.md)
